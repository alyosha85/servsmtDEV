    ...
    <div class="card-body col-lg-12 mt-0">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif notizen" name="message" rows="3" height="100px" style="resize:none;" ></textarea>
            </div>
            ...
            <div>
              <div class="col-lg-12">
                ...
                <p style="color:#661421; font-weight:bold;">Zum hinzufügen von weiteren Kommentaren klicken Sie bitte "Wiederherstellen".</p>
