...
$.ajaxSetup({
  ...
  $("div#UnderCard").children().remove();
    ...
    console.log(resp.locationAddress)
    ...
    for (const item of resp.locationContacts) {
      console.log(resp.locationContacts)
        ...
        `<div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
          <div class="card bg-light col-md-12">
            <div class="card-header text-muted border-bottom-0 bg-light">
              <p style="color:#661421; font-size:larger; font-weight:bold; ">${item.position}</p> 
            </div>
            <div class="card-body pt-0">
            <div class="row">
              <div class="col-6">
                <h3 style="color:#661431; font-weight:bold; ">${item.name},&nbsp${item.vorname}</h3>
                <br>
                <p class="text-sm">
                ...
                <p class="text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" data-name="Layer 1" viewBox="0 0 24 24"><path fill="#0369a1" d="M14,8h1a1,1,0,0,0,0-2H14a1,1,0,0,0,0,2Zm0,4h1a1,1,0,0,0,0-2H14a1,1,0,0,0,0,2ZM9,8h1a1,1,0,0,0,0-2H9A1,1,0,0,0,9,8Zm0,4h1a1,1,0,0,0,0-2H9a1,1,0,0,0,0,2Zm12,8H20V3a1,1,0,0,0-1-1H5A1,1,0,0,0,4,3V20H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Zm-8,0H11V16h2Zm5,0H15V15a1,1,0,0,0-1-1H10a1,1,0,0,0-1,1v5H6V4H18Z"/></svg>
                ...
                <p class="text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" fill="#9f1239" stroke-width="1px" stroke="#000"><path d="M53.26 54.62a4.09 4.09 0 0 0 2.51-5.22l-1.36-3.87A4.1 4.1 0 0 0 49.18 43c-7.73 2.71-10.45-5-11.81-8.88S33.3 22.55 41 19.83a4.1 4.1 0 0 0 2.51-5.22l-1.36-3.87A4.1 4.1 0 0 0 37 8.23c-9.66 3.4-14.1 9.3-7.31 28.63S43.6 58 53.26 54.62z"/><path d="M34.81 48.18A4 4 0 0 0 32 52a4 4 0 0 1-8 0 4 4 0 0 0-8 0 4 4 0 0 1-8 0"/></svg>
                    <span class="ml-3" style="color:#661421; font-weight:bold;">${item.privat}</span></p>
                <p class="text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <span class="ml-3" style="color:#661421; font-weight:bold;">${item.Mobil}</span></p>
              </div>
              <div class="col-6 text-center">
                ...
                <p class="text-sm mt-4">                  
                    <span class="ml-3" style="color:#661421; font-weight:bold;">${item.username}</span></p>
                <p class="text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#92400e" d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg>                 
                    <span class="ml-3" style="color:#661421; font-weight:bold;">${item.beschreibung}</span></p>
              </div>
            </div>
          </div>
        </div>
